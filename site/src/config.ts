...
export const links = {
  ...
  iosTracking: "https://github.com/vitorsalomao05/houdini/issues/1",
};

// The fastest path that WORKS TODAY for the menu bar app: a one-liner that
// downloads the ad-hoc-signed Houdini.app + houdini from the pinned v0.1.1
...
// repo and run its idempotent installer (builds houdini + deploys the widget).
